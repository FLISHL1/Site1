...
<body>
    ...
    <main>
        ...
        <div class='aboutUs'>
            ...
            <p class="text">Добро пожаловать в Котофей – место, где забота о вашем питомце становится увлекательным и приятным опытом! <br>
                Мы - команда преданных любителей животных, которые разделяют вашу страсть к заботе о маленьких членов вашей семьи.</p>
        </div>
        ...
        <div class='mission'>
            ...
            <p class="text">Мы стремимся сделать заботу о вашем питомце легкой, веселой и доступной. <br >
                Наша миссия – предоставить вам широкий выбор высококачественных товаров для домашних животных, от лучших брендов, чтобы ваш питомец чувствовал себя счастливым и заботимым.</p>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="row">От питательных кормов и вкусных лакомств до удобных аксессуаров и уютных домиков - у нас есть все необходимое для заботы о вашем питомце.</td>
                </tr>
                <tr>
                    <td class="row">Экспертные Рекомендации</td>
                    <td class="row">Наши сотрудники - настоящие эксперты по уходу за животными. <br>
                        Готовы поделиться советами и рекомендациями, чтобы сделать жизнь вашего питомца еще более радостной.</td>
                </tr>
            </tbody>
        </table>
    </main>
