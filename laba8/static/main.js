...
function autocomplete(event) {
    ...
    if (value.length > 0) {
        // Make a request to your server for autocomplete suggestions
        // Replace 'your-api-endpoint' with the actual endpoint
        fetch(`http://cat-facts-api.std-900.ist.mospolytech.ru/autocomplete?q=${value}`)
            ...
            .then(data => {
                data.forEach(suggestion => {
                    ...
                    li.addEventListener("click", e => {
                        ...
                        document.getElementById("search").value = li.textContent; 
